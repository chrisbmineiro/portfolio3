...
function toggleLanguage(language) {
    ...
    const portugueseContent = `
        <div>
            ...
            <p>Um curso de informática associado ao SENAI, onde pude entender melhor como tudo acontecia, no próximo ano fiz no mesmo instituto um curso de inglês do básico ao intermediário e hoje estou cursando o 5° semestre de Ciência da Computação, onde estou aprendendo de tudo um pouco e acabei me interessando bastante pela parte de Web, pois sempre gostei do trabalho criativo e artístico através de códigos.</p>
    ...
    const englishContent = `
        <div>
            ...
            <ul class="redes-sociais">
                <li>
                    <a href="https://www.linkedin.com/in/chrisbmineiro" title="minha pagina no linkedin" target="_blank">
                        <i class="fab fa-linkedin-in"></i>
                    </a>
                </li>
                <li>
                    <a href="http://whatsapp.me/5511985154394" title="meu numero para contato" target="_blank">
                        <i class="fab fa-whatsapp"></i>
                    </a>
                </li>
                <li>
                    <a href="https://github.com/chrisbmineiro" title="meu github" target="_blank">
